...
document.querySelector("form").addEventListener("submit", function(event) {
    ...
    // Kiểm tra nếu phương thức là mã QR thì chuyển hướng sang trang mã QR
    if (paymentMethod === "2") {  // Thay "qr_code_method_id" bằng ID tương ứng của phương thức mã QR
        event.preventDefault();
        window.location.href = "/order/qrcode"; // Đường dẫn trang mã QR
    }
});
